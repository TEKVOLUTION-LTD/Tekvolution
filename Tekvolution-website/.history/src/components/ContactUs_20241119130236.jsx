...
const ContactUs = () => {
  ...
  // Code for restricting just letter in the firstname and lastname input boxes
        ...
        <form onSubmit={sendEmail}>
          <div className="flex justify-between mb-4">
            <div className="w-1/2 mr-2">
              <label htmlFor="first_name" className="block text-gray-600 mb-2">First Name</label>
              <input
                type="text"
                id="first_name"
                name="first_name"
