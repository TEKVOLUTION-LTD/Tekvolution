...
//     emailjs
//       .sendForm(
//         'service_010uzbl', // Replace with your EmailJS Service ID
//         'template_t6co6zg', // Replace with your EmailJS Template ID
//         e.target,
...
export const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_dhjq67c', 'template_t6co6zg', form.current, {
        publicKey: '5SBsvEKQeyeUXKld7',
      })
      .then(
        () => {
          console.log('SUCCESS!');
