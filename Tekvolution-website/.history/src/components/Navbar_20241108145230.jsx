          ...
          <div className="relative">
            ...
            {isServicesOpen && (
              <div className="absolute bg-white border shadow-lg mt-2 rounded-lg w-48 z-10">
                ...
                <a
                  onClick={() => scrollToSection(refs.talentDevelopmentRef)} href="#recruit-development"
                  className="block px-4 py-2 text-gray-800 hover:bg-gray-200"
                >
...
{/* mobile Drawer open and close toggle links */}
      {mobileDrawerOpen && (
          <div className="right-0 max-w-screen-sm  bg-purple-600 z-20  w-full screen- flex flex-col justify-start items-start text-white p-12  lg:hidden">

<a onClick={() => scrollToSection(refs.heroSectionRef)} href="#home" className=" hover:text-black pb-2 ">
            Home
          </a>
          <a onClick={() => scrollToSection(refs.aboutUsRef)} href="#about-us" className=" hover:text-black pb-2">
            About Us
          </a>
          ...
          <div className="relative">
            ...
            {isServicesOpen && (
              <div className="absolute mx-[5rem]  bg-white text-purple-600 border shadow-lg mt-2 rounded-lg w-48 z-10">
                ...
                <a
                  onClick={() => scrollToSection(refs.talentDevelopmentRef)} href="#talent-development"
                  className="block px-4 py-2  hover:bg-gray-200"
                >
                  Talent Development/Outsourcing
                </a>
