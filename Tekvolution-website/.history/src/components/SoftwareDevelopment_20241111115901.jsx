 ...
 <>
    ...
    <div   className='block sm:flex mx-10 justify-center items-center my-10 gap-5 '>
      ...
      <div className='  justify-center text-center lg:mr-[2rem]  lg:w-1/2'>
            ...
            <button  onClick={() => contactUsRef.current.scrollIntoView({ behavior: 'smooth' })} id='#contact'  
 className="bg-[#C823ED] hover:bg-pink-500 text-white font-bold py-2 px-4 mt-5 mb-5 lg:mb-0 rounded-3xl">Let's Talk About Your Idea
          </button>
            </div>
