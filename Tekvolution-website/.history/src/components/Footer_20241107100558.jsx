...
<a onClick={()=> scrollToSection(refs.softwareDevelopmentRefs)} href="http://" target="_blank" rel="noopener noreferrer">Software Development</a> <br />
<a href="http://" target="_blank" rel="noopener noreferrer">Product Development</a> <br />
<a onClick={() => scrollToSection(refs.talentDevelopmentRef)} href="http://" target="_blank" rel="noopener noreferrer">Talent Development/outsourcing</a>
</div>
      
    {/* Support */}
    <div className='items-center text-center pb-4 mb-10 '>
<h1 className='font-bold text-xl'>Support</h1>
<a href="http://" target="_blank" rel="noopener noreferrer">About Us </a><br />
