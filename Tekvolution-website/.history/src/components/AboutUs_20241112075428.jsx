...
return (
    <div className="max-w-6xl mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 my-10 lg:my-20 ">
      ...
      <div className=" overflow-scroll lg:overflow-hidden h-[20rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 pt-2 lg:pt-10">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">About Us</h2>
        <p className="text-gray-600 mb-4 lg:text-lg text-lg">At TEKVOLUTION LTD, we’re not just solving today's problems – we’re building the technology that empowers tomorrow’s possibilities. Committed to revolutionizing how users interact with technology by building solutions that simplify tasks and prioritize automation.
      ...
      <div className=" overflow-scroll lg:overflow-hidden h-[20rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 pt-2 lg:pt-5">
        ...
        <p className="text-gray-600 mb-4 lg:text-lg text-lg">Our vision is to lead the future of technology by building a smarter, more connected world where automation and innovation simplify everyday tasks, driving growth and efficiency for businesses and individuals alike. We aim to be the catalyst for a tech-driven future that prioritizes user experience and elevates global productivity.</p>
      </div>
