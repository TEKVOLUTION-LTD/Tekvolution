...
const ContactUs = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto lg:flex sm:block md:flex justify-between gap-10">
      {showSuccessMessage ? (
        <div className="bg-white-100 border border-pink-400 text-purple-700 px-4 py-3 rounded relative mx-10 lg:mx-0">
          <p>Your message has been sent successfully!</p>
          <button
            onClick={() => setShowSuccessMessage(false)}
            className="mt-4 bg-[#C823ED]  hover:bg-pink-500 text-[#C823ED]  font-bold py-2 px-4 rounded-3xl mx-auto justify-center items-center"
          >
            Dismiss
          </button>
        </div>
