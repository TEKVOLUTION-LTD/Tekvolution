...
<div className="max-w-6xl mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 my-10 lg:my-20 ">
      ...
      <div className=" h-[20rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 pt-6 lg:pt-5">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Client Requirement Gathering</h2>
        <p className="text-gray-600 mb-4 lg:text-lg text-xl">Our team collaborate with hiring managers to create a detailed job description outlining qualifications, responsibilities, and expectations.
      ...
      <div className=" h-[20rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 pt-4 lg:pt-10">
        ...
        <p className="text-gray-600 mb-4 lg:text-lg text-xl">Confirming the target candidate profile and understanding your industry preferences, our team uses various channels to quickly attract candidates, including job boards, social media, and referrals.</p>
      </div>
      ...
      <div className=" h-[20rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 lg:pt-5 pt-4">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Screening and Shortlisting </h2>
        <p className="text-gray-600 mb-4 lg:text-lg  text-xl">Administer relevant tests or assignments to evaluate candidates' technical skills and problem-solving abilities. Conduct phone or video interviews to assess the candidate’s skills and fit.</p>
      </div>
