...
<div className="max-w-6xl mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 my-10 lg:my-20 ">
      ...
      <div className="lg:h-[20rem] h-[22rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 lg:pt-5 pt-2">
      ...
      <div className=" lg:h-[20rem] h-[24rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2 lg:pt-5 pt-1">
      ...
      <div className=" lg:h-[20rem] h-[25rem] justify-center text-center lg:pr-12 sm:pr-2 lg:pl-12 sm:pl-2  pt-2 lg:pt-5">
