...
<a href="http://www.info@tekvolution.com.ng" target="_blank" rel="noopener noreferrer" className='hover:text-black'>info@tekvolution.com.ng</a>
...
<a onClick={()=> scrollToSection(refs.softwareDevelopmentRef)} href="#software-development" rel="noopener noreferrer" className='hover:text-black'>Software Development</a> <br />
<a href="http://" target="_blank" rel="noopener noreferrer" className='hover:text-black'>Product Development</a> <br />
<a onClick={() => scrollToSection(refs.talentDevelopmentRef)} href="#talent-development" rel="noopener noreferrer" className='hover:text-black'>Talent Development/outsourcing</a>
</div>
      
    {/* Support */}
    <div className='items-center text-center pb-4 mb-10 '>
<h1 className='font-bold text-xl'>Support</h1>
<a onClick={() => scrollToSection(refs.aboutUsRef)} href="#aboutUs" rel="noopener noreferrer"className='hover:text-black'>About Us </a><br />
<a href="http://" rel="noopener noreferrer" className='hover:text-black'>FAQ</a><br />
