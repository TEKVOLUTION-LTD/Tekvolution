...
<a href="http://info@tekvolution.com.ng" target="_blank" rel="noopener noreferrer">info@tekvolution.com.ng</a>

<div className='flex justify-center items-center '>
  <a href="http://" target="_blank" rel="noopener noreferrer"></a>  <img src= {Linkdlin} alt="Linkdlin" className='h-8 w-8 object-contain pr-2' />
