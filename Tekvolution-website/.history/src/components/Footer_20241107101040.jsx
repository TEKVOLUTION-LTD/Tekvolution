...
<a onClick={()=> scrollToSection(refs.softwareDevelopmentRefs)} href="#software-development" rel="noopener noreferrer">Software Development</a> <br />
<a href="http://" target="_blank" rel="noopener noreferrer">Product Development</a> <br />
<a onClick={() => scrollToSection(refs.talentDevelopmentRef)} href="#" rel="noopener noreferrer">Talent Development/outsourcing</a>
</div>
