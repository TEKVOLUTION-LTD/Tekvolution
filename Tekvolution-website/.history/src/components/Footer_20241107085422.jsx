...
<div className='flex justify-center items-center '>
  <a href="https://www.linkedin.com/company/tekvolution-ltd/" target="_blank" rel="noopener noreferrer"></a>  <img src= {Linkdlin} alt="Linkdlin" className='h-8 w-8 object-contain pr-2' />
