...
function App() {
  ...
  return (
    ...
    <div className=' lg:ml-[2rem]'> <Navbar scrollToSection={scrollToSection} refs={{
       ...
       <BrowserRouter>
 // ...
 <div ref={academyRef}> <Academy contactUsRef={contactUsRef}/> </div> 
      <div ref={contactUsRef} className=' bg-[#FDEFFF]' id="contact">
        <ContactUs />
      </div>
      // ...

      <div ref={softwareDevelopmentRef} className='bg-[#FDEFFF] mx-auto '> <SoftwareDevelopment contactUsRef={contactUsRef} /> </div>
      
     
      // ...

      <div ref={talentDevelopmentRef} className=' bg-[#FDEFFF] mx-auto' >  < TalentDevelopment  contactUsRef={contactUsRef}/> </div>
    </BrowserRouter>

    
       {/* <div ref={contactUsRef} id='#contact' className=' bg-[#FDEFFF]'>  < ContactUs  /></div>

       <div ref={softwareDevelopmentRef} contactUsRef={contactUsRef} className=' ' >  < SoftwareDevelopment  /> </div> */}
